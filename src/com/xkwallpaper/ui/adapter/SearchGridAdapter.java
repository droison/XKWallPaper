...
public class SearchGridAdapter {
	...
	public SearchGridAdapter(LinearLayout layout1, LinearLayout layout2, MainActivity mActivity) {
	...
	private void completeAdd() {
		SearchGridListAdapter adapter = new SearchGridListAdapter(papers1, mActivity);
		...
		adapter = new SearchGridListAdapter(papers2, mActivity);
